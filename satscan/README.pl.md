...
sterowniki demuxa (widziane na Zgemmach) ignorują część extension filtra
...
- **satscan-armhf** — ARMv7 + VFPv3-D16, **NEON jawnie wyłączony**: część
  SoC-ów STB (np. Zgemma H8) nie ma NEON i domyślny baseline daje SIGILL;
...
- **satscan-mipsel** — MIPS32 **r1**: starsze Broadcomy MIPS (np. BCM7362
  w Zgemmie H3) dają SIGILL na instrukcjach r2. Dodatkowo MIPS inaczej
...
|---|---|---|
| VU+ (2×DVB-S2X) | armv7l | uniwersalny LNB, bez DiSEqC |
| VU+ FBC (8×) | armv7l | Unicable EN50494 (Sharp, auto z settings) |
| Zgemma H8 | armv7l, bez NEON | uniwersalny LNB |
| Zgemma H3 | mipsel r1 | uniwersalny LNB |
